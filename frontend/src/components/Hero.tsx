    ...
    return (
        <div className='w-full bg-[#5F6FFF] p-8 flex items-center gap-4 flex-col-reverse md:flex-row rounded-lg text-white mb-6'>
            <div className='px-6 md:w-[65%] w-full'>
                ...
                <button className='py-3 px-4 bg-white flex gap-2 items-center justify-center text-black rounded-3xl cursor-pointer hover:scale-105 transition-all'>Book appointment <FaArrowRightLong size={18} /></button>
            </div>
